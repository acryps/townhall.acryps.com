...
export const mapStyle = () => select('ui-map-container',
	...
	child('svg',
		...
		child('g',
			child('path', fill('#fff1')),
			child('rect', fill('#fff1'))
		)
	)
)
