...
export class Layer {
    ...
    render(map: Map) {
        ...
        this.path = document.createElementNS(this.namespace, 'path') as SVGPathElement;
        this.update();
    ...
    update() {
        ...
        this.path.setAttributeNS(null, 'd', `${this.points.map((point, index) => `${index ? "L" : "M"}${point.x} ${point.y}`)} Z`);
