...
ALTER TABLE train_route ADD operator_id UUID CONSTRAINT operator__operated_train_routes REFERENCES company (id);
...
ALTER TABLE train_route ADD active_path_id UUID CONSTRAINT active_path__ REFERENCES train_route (id);
